...
<body>
	<div class="container">
		...
		<br>
		<div class="input-container">
			<textarea id="stdout" class="input" rows="10"
				style="display:none; resize: vertical; background: #1e1e1e; color: #4AF626;" readonly></textarea>
		</div>
		<div class="input-container">
			<textarea id="stderr" class="input" rows="5"
				style="display:none; resize: vertical; background: #1e1e1e; color: #C50F1F;" readonly></textarea>
		</div>
	</div>
	<div class="credit">Made with ❤️ by <a href="https://sadiq.is-a.dev" target="_blank"
			style="text-decoration: none;">Sadiq</a></div>
</body>
<script>
